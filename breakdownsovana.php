...
<head>
    ...
    <style>
        body {
            ...
            font-size: small;
            background-image: url('templates/images/bg04.png');
            filter: grayscale();
            background-repeat: no-repeat;
            background-size: cover;
            background-position: center;
            background-color: #fcfaf894;
            /* color: rgb(1, 23, 23); */
        }
        .card {
            background-color: #fcfaf894;
...
<!-- konten -->
    <!-- Kolom full -->
    <div class=" mt-3 mb-3 align-content-center px-lg-1">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-4 col-md-6 col-xl-4 mb-3">
                <div class="card p-2">
                    ...
                    <div class="card-body">
                        <?php include_once 'breakdown/sovana/table/tabel-harga.php' ?>
                    </div>
                </div>
            </div>
            <!-- Kolom tengah   //////////////////////////////////////////////////////////////////////////////////////////// -->
            <div class="col-sm-3 col-md-6 col-xl-3">
                <div class="card p-2">
                    ...
                    <div class="card-body">
                        <?php include_once 'breakdown/sovana/form/input.php' ?>
            ...
            <div class="col-sm-5 col-md-10 col-xl-5 card">
                ...
                <div class="card-body">
                    <?php include_once 'breakdown/sovana/table/tableCetak.php' ?>
                    <hr>
