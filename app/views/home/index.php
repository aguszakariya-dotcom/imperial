          ...
          <div class="col-md-8">
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                    <span class="badge badge-danger" id="newMembersBadge">New Members</span>
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list" id="user-list">
                      <!-- <li>
                        ...
                        <span class="users-list-date">Penjahit</span>
                      </li> -->
                    </ul>
                    <!-- /.users-list -->
                    <style>
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="<?= BASEURL; ?>/produksi" class="btn btn-sm btn-info float-left">Place New Order</a>
                <a href="<?= BASEURL; ?>/produksi" class="btn btn-sm btn-secondary float-right">View All Orders</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
