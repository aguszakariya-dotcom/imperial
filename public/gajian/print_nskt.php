...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title btn btn-outline-danger text-center shadow fw-bold">Pastikan, Nama, Hadir dan lembur sudah sesuai !</h5>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-7 col-sm-12 col-md-12 mt-3 px-3">
            ...
            <div class="card-header">
                ...
                <a class="btn btn-sm btn-outline-primary d-print-none mx-3 shadow" href="input_nskt.php">input Data</a>
                ...
                <table class="table-clear mb-3 p-5">
                    <tr>
                        <td class="p-2 dari">
                            ...
                            <div>
                                <a href="index.php"><img class="center" src="img/bg.png" alt="" width="200"></a>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.modal').modal('show');
            // $('#namaPegawai').val('Aulia margareta'); 
        });
    </script>
