  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class=" btn-sm btn btn-outline-warning mx-3" aria-current="page" href="index.php">Tk Jahit</a>
        </li>
        <li class="nav-item">
    ...
    <div class=" mt-5 mb-3 align-content-center px-lg-2">
        <div class="row ">
                ...
                <div class="card-body">
                    <table id="dataTable" class="table table-hover ">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="table-ptg text-light" data-customer="<?php echo $row['nama_customer']; ?>" data-style="<?php echo $row['style']; ?>" data-warna="<?= $row['warna']; ?>" data-qty="<?= $row['qty']; ?>" data-harga="<?php echo $row['motong']; ?>">
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $row['nama_customer']; ?></td>
                                    <td><?php echo $row['style']; ?></td>
                                    <td><?= $row['warna']; ?></td>
                                    <td><?= $row['qty']; ?></td>
                                    <td><?= number_format($row['motong'], 0, ',', '.'); ?></td>
                                </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
            ...
            <!-- batas samping kiri -->
            <div class="col-sm-3 p-3 shadow ">
                <div class="card px-1">
                <div class="card-header text-center text-light fs-6">
                    Input Salary Cutter
                </div>
                <div class="card-body text-light">
                    <form id="myform">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama" value="Aulia Margareta" id="nama">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="text-center" id="tombol">
                            ...
                            <a class="btn btn-sm btn-outline-info" href="print_ptg.php">Cetak</a>
            ...
            <div class="col-sm-5 p-2 shadow ">
                ...
                <div class="card-header text-center">
                    ...
                    ?>
                    <button class=" btn btn-outline-info text-light fs-6 shadow text-center">Grand Total : Rp.
